...
namespace InputRetrieval
{
	...
	// a consistent filename in which the day number is zero-padded to
	// a 2-digit length, giving a full path like:
	...
	std::ifstream GetInputStreamForPuzzleInput(unsigned int day);
}